            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <p id="dr"></p>
                        <label><strong><?php echo e(trans('Date')); ?></strong><input type="text" data-date-format='yy-m-d' id="datepicker" class="form-control"></label>
...
<script type="text/javascript">
    ...
    function datatable_sum(dt_selector, is_calling_first) {
        if (dt_selector.rows( '.selected' ).any() && is_calling_first) {
            ...
            $( dt_selector.column( 11 ).footer() ).html(dt_selector.cells( rows, 10, { page: 'current' } ).data().sum().toFixed(2));
        }
        else {
            $( dt_selector.column( 8 ).footer() ).html(dt_selector.cells( rows, 8, { page: 'current' } ).data().sum());
            $( dt_selector.column( 9 ).footer() ).html(dt_selector.cells( rows, 9, { page: 'current' } ).data().sum().toFixed(2));
